 ...
 */
package edu.gatech.edutech.smarterap.controller;

import edu.gatech.edutech.smarterap.model.Toot;
import edu.gatech.edutech.smarterap.model.User;
import edu.gatech.edutech.smarterap.model.dao.CustomerDao;
import edu.gatech.edutech.smarterap.model.sdk.StormpathService;
import edu.gatech.edutech.smarterap.model.dao.TootDao;
import edu.gatech.edutech.smarterap.validator.TootValidator;
...
public class TootController {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "/smarterap")
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/smarterap")
    ...
    @RequestMapping("/smarterap/remove")
