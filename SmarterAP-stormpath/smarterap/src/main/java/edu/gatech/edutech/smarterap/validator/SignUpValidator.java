 ...
 */
package edu.gatech.edutech.smarterap.validator;
...
public class SignUpValidator implements Validator {
    ...
    public void validate(Object o, Errors errors) {
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "password", "signUp.required.password", "Field password is required");
