...
<html lang="en">
<head>
    <title id="pageTitle"><spring:message code="smarterap.title"/></title>
...
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        <a class="brand" style="margin-left: 0px;" href="https://www.stormpath.com"><spring:message code="smarterap.title"/></a>
        <ul class="nav">
            <li class="active"><a href="<c:url value='/smarterap'/>">Home</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="<c:url value='/logout'/>"><spring:message code="smarterap.logout"/></a></li>
                </ul>
            </li>
        </ul>
    </div>
                            ...
                            <c:if test="${sessionScope.permissionUtil.hasRole(sessionScope.sessionUser, 'ADMINISTRATOR')}">
                                <button class="close" title="Delete the toot permanently"
                                        onclick="window.location.href='<c:url
                                                value='/smarter/remove?id=${tootItem.tootId}'/>'">&times;</button>
                            </c:if>
                        </c:when>
                        <c:otherwise>
