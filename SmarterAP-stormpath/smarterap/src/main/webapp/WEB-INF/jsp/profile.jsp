...
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        <a class="brand" style="margin-left: 0px;" href="https://www.stormpath.com">SmarterAP</a>
        <ul class="nav">
            <li><a href="<c:url value='/smarterap'/>">Home</a></li>
        ...
        <div class="span12">
            ...
            <form:form method="POST" commandName="user">
                ...
                <div class="<c:out value="${controlGroupClass}"/>">
                    ...
                    <label class="radio inline">
                        <form:radiobutton path="groupUrl" cssClass="radio" value="${TEACHER_URL}"/> Teacher
                    </label>
                    <label class="radio inline">
                        <form:radiobutton path="groupUrl" cssClass="radio" value="${STUDENT_URL}"/> Student
                    </label>
                </div>
