...
.controller("StudentAssessmentDashboardController", StudentAssessmentDashboardController);

function StudentAssessmentDashboardController($q, $timeout, $state, $stateParams, $mdDialog, $document, $http, Ui) {
    var ctrl = this;
    ...
    function init() {
        ...
        $http.get('/smarter-ap/api/assessment/student/' + $stateParams.assessmentId)
            .then(
                function(response) {
